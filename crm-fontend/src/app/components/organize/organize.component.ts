...
import { Product, Category, Color, Size, Style, Tag, SleeveLength, Type } from '../../api';
import { InventoryRequest } from '../../api';
import { InventoryControllerService, Storage } from '../../api';
@Component({
    selector: 'app-organize',
    imports: [CommonModule, MatCardModule, MatCheckboxModule, FormsModule, MatButtonModule, MatBottomSheetModule, MatIconModule, MatFormFieldModule, MatSelectModule, MatListModule, ReactiveFormsModule],
...
export class OrganizeComponent implements OnInit {
    ...
    constructor(private productService: ProductControllerService, private attributesService: AttributesControllerService, private fb: FormBuilder) {
    ...
    openBottomSheet(): void {
        ...
        this._bottomSheet.open(BottomSheetOverviewExampleSheet, { data: this.selectedProducts });
    }
    ngOnInit(): void {
        ...
        this.productService
            ...
            .subscribe(
                (data: Product[]) => {
                    ...
                    this.products = data; // Assign the fetched products to the component's products property
                },
                (error) => {
...
@Component({
    ...
    styleUrl: './organize.component.css',
    imports: [CommonModule, MatListModule, FormsModule, MatFormFieldModule, MatSelectModule, MatButtonModule, MatBottomSheetModule, ReactiveFormsModule],
})
