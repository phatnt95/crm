...
export class ProductControllerService extends BaseService {
  ...
  public createItem(
    ...
    if (product === null || product === undefined) {
      throw new Error(
        'Required parameter product was null or undefined when calling createItem.'
      );
    }
  ...
  public createProduct(
    ...
    if (files === null || files === undefined) {
      throw new Error(
        'Required parameter files was null or undefined when calling createProduct.'
      );
    }
    ...
    if (files) {
      if (localVarUseForm) {
        files.forEach((element) => {
          localVarFormParams =
            (localVarFormParams.append('files', <any>element) as any) ||
            localVarFormParams;
        });
      } else {
        localVarFormParams =
  ...
  public getAllItems(
    ...
    let localVarPath = `/api/product`;
    return this.httpClient.request<Array<ProductDTO>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public getImage(
    ...
    let localVarPath = `/api/product/image/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
